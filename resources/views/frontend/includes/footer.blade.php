        ...
        <div class="row">
            <div class="footer-container d-flex">
                        ...
                        <div class="col-md-4">
                            <div class="footer-list">
                                <ul>
                                    ...
                                    <li><i class="fa fa-angle-right" aria-hidden="true"></i><a
                                                href="https://rtionline.gov.in/RTIMIS/login/index.php" target="_blank">RTI
                                            online</a></li>
                                    <li><i class="fa fa-angle-right" aria-hidden="true"></i><a
                                                href="https://pgportal.gov.in/" target="_blank">PG portal</a></li>
                        ...
                        <div class="col-md-8">
                            <div class="footer-list">
                                <ul>
                                    ...
                                    <li><i class="fa fa-angle-right" aria-hidden="true"></i><a
                                                href="https://www.aicte-india.org/" target="_blank">AICTE</a></li>
                                    <li>
                                        <i class="fa fa-angle-right" aria-hidden="true"></i><a
                                                href="https://www.nta.ac.in/" target="_blank">National Testing Agency
                                            (NTA)</a>
                        ...
                        <div class="col-md-8">
                            <div class="footer-list">
                                <ul>
                                    ...
                                    <li>
                                        <i class="fa fa-angle-right" aria-hidden="true"></i><a
                                                href="https://scholarship.canarabank.in/" target="_blank">
                                            Web portal for
                                            Fellowship/Scholarship Legacy Cases
                                        </a>
                                    </li>

                                    <li>
                                        <i class="fa fa-angle-right" aria-hidden="true"></i><a
                                                href="http://rusa.nic.in/" target="_blank">
                                    ...
                                    <li>
                                        <i class="fa fa-angle-right" aria-hidden="true"></i><a
                                                href="https://uamp.ugc.ac.in/" target="_blank">
                                            University Activity
                                            Monitoring Portal
                                        </a>
                                    </li>
                                    <li><i class="fa fa-angle-right" aria-hidden="true"></i><a
                                                href="https://deemed.ugc.ac.in/" target="_blank">Deemed to be University
                                            Portal </a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="footer-list">
                                <ul>
                                    ...
                                    <li>
                                        <i class="fa fa-angle-right" aria-hidden="true"></i><a
                                                href="https://deb.ugc.ac.in/" target="_blank"> DEB</a>
                                    </li>
                ...
                <div class="col-sm-3 contacts">
                    ...
                    <ul>
                        ...
                        <li>
                            <p>Phone: 011-23604446, 011-23604200</p>
                        </li>
                        <li><a href="#">Email: contact.ugc@nic.in</a></li>
                    </ul>
                    <div class="visitor_text">
                        <span>
                            <b>Total Visitors</b><small>
                                <label id="lblcount" text="Hit Counter">216516731</label>
                            </small>
                        </span>
                    </div>
            ...
            <div class="container footer-img">
                <div class="col-md-12">
                    ...
                    <div class="col-md-2 col-sm-4 col-xs-6 bg_white fl-0">
                        <a href="http://www.goidirectory.gov.in/index.php" target="_blank"
                           title="Government of India Web Directory">
                            <img alt="GOI" src="{{asset('assets/img/MainPage/GOI.png')}}" height="51">
                        </a>
                    </div>
                </div>
            </div>
